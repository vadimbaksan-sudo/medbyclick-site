  ...
  return (
    <div className="border border-stone-200 rounded-2xl p-6 bg-white">
      <div className="flex items-center justify-between mb-6">
        <div>
          <p className="text-xs text-stone-400 mb-1">Your Balance</p>
        ...
        <div className="text-right">
          <p className="text-xs text-stone-400 mb-1">Current Tier</p>
          <p className="font-bold text-stone-900">{currentTier.name}</p>
        </div>
      </div>
      ...
      <div>
        <p className="text-xs font-medium text-stone-500 mb-2">Your perks</p>
