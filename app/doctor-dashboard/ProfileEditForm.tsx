    ...
    <div className="border border-slate-200 rounded-2xl p-6">
      ...
      <form action={action} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label htmlFor="responseTime" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="credentials" className="block text-sm font-medium text-slate-700 mb-1.5">
            Credentials
          </label>
          <input
            id="credentials"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="languages" className="block text-sm font-medium text-slate-700 mb-1.5">
              Languages
            </label>
            <input
              id="languages"
          ...
          <div>
            <label htmlFor="subspecialties" className="block text-sm font-medium text-slate-700 mb-1.5">
              Subspecialties
            </label>
            <input
              id="subspecialties"
        ...
        <button
          type="submit"
          disabled={pending}
          className="py-2.5 px-5 bg-slate-900 hover:bg-slate-700 disabled:opacity-60 text-white font-semibold rounded-lg text-sm transition-colors"
        >
          {pending ? "Saving…" : "Save profile"}
        </button>
      </form>

      <dl className="mt-6 pt-6 border-t border-slate-100 grid grid-cols-2 gap-x-6 gap-y-2 text-xs">
        <dt className="text-slate-400">Specialty</dt>
        <dd className="text-slate-600">{doctorProfile.specialty}</dd>
        <dt className="text-slate-400">Vetting status</dt>
        <dd className="text-slate-600 capitalize">{doctorProfile.vettingStatus}</dd>
      </dl>
    </div>
  );
}
