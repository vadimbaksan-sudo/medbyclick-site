          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                <div key={item.title} className="flex gap-4 p-5 rounded-xl border border-stone-100 bg-stone-50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-stone-900">Meet the network</h2>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {featured.map((doctor) => (
              ...
              >
                ...
                <p className="text-xs text-stone-400 mt-3 not-italic">— Founder&apos;s endorsement</p>
              </Link>
            ))}
          </div>
