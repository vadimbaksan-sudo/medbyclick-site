  ...
  if (state === "success") {
    return (
      <div className="text-center py-12">
        ...
        <Link
          href="/dashboard/"
          className="inline-flex items-center px-5 py-2.5 bg-slate-900 text-white rounded-xl text-sm font-semibold hover:bg-slate-700 transition-colors mt-6"
        >
          Go to dashboard
        </Link>
      </div>
  ...
  if (loadError) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/login" className="text-sm font-medium text-slate-600 hover:text-slate-900 underline">
