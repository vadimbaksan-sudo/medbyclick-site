...
export default function MedPaymentsClient() {
  ...
  return (
    <>
      ...
      <div ref={paymentRef} className="bg-stone-50 border-t border-stone-100 py-16 scroll-mt-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-stone-900 mb-3">Choose a Payment Method</h2>
            {selectedPlan ? (
